...
public class meganesatinalim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meganesatinalim);
    ...
    {
        Intent intent=new Intent(meganesatinalim.this,renaultmegane.class);
            ...
            builder.setMessage("Renault Megane aracı başarıyla kiralandı")
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Intent intent = new Intent(meganesatinalim.this, MovementActivity.class);
                            visibellel4=true;
                            startActivity(intent);
                        }
                    });
