...
public class scalasatinalim extends AppCompatActivity {
    public static boolean visibellel6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scalasatinalim);
    ...
    {
        Intent intent=new Intent(scalasatinalim.this,skodascala.class);
    ...
    public void Onayla(View view) {
        ...
        if (selectedDate1.after(today) || selectedDate2.after(today)) {
            ...
            kiralamaBilgileri.put("Araç Model", "Skoda Scala"); // Burada aracın kimliğini eklemelisiniz
            ...
            db.collection("Kullanıcılar.").document(uid).collection("Kiralananlar")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            Toast.makeText(scalasatinalim.this,"Kiralama bilgileri başarıyla eklendi:"+documentReference.getId(),Toast.LENGTH_SHORT).show();
                        }
                    });
            // AlertDialog oluştur
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("Skoda Scala aracı başarıyla kiralandı")
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            // MovementActivity'e geçiş yap
                            Intent intent = new Intent(scalasatinalim.this, MovementActivity.class);
                            visibellel6=true;
                            startActivity(intent);
                        }
                    });
