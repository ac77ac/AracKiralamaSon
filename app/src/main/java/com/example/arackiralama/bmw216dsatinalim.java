...
public class bmw216dsatinalim extends AppCompatActivity {
    public static boolean visibellel9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bmw216dsatinalim);
    ...
    {
        Intent intent=new Intent(bmw216dsatinalim.this,bmw216d.class);
    ...
    public void Onayla(View view) {
        ...
        if (selectedDate1.after(today) || selectedDate2.after(today)) {
            ...
            kiralamaBilgileri.put("Araç Model", "Bmw216d"); // Burada aracın kimliğini eklemelisiniz
            ...
            db.collection("Kullanıcılar.").document(uid).collection("Kiralananlar")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            Toast.makeText(bmw216dsatinalim.this,"Kiralama bilgileri başarıyla eklendi:"+documentReference.getId(),Toast.LENGTH_SHORT).show();
                        }
                    });
            ...
            builder.setMessage("Bmw 216d aracı başarıyla kiralandı")
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            // MovementActivity'e geçiş yap
                            Intent intent = new Intent(bmw216dsatinalim.this, MovementActivity.class);
                            visibellel9=true;
                            startActivity(intent);
                        }
                    });
