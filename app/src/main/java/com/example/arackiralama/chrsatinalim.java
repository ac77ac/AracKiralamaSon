...
public class chrsatinalim extends AppCompatActivity {
    public static boolean visibellel8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chrsatinalim);
    ...
    public void backclick(View view) {
        Intent intent = new Intent(chrsatinalim.this, toyotachr.class);
    ...
    public void Onayla(View view) {
        ...
        if (currentUser != null) {
            ...
            if (selectedDate1.after(today) || selectedDate2.after(today)) {
                ...
                kiralamaBilgileri.put("Araç Model", "Toyoya C-HR"); // Burada aracın kimliğini eklemelisiniz
                ...
                db.collection("Kullanıcılar.").document(uid).collection("Kiralananlar")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                Toast.makeText(chrsatinalim.this, "Kiralama bilgileri başarıyla eklendi:" + documentReference.getId(), Toast.LENGTH_SHORT).show();
                            }
                        });
            }
            // AlertDialog oluştur
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("Toyota C-HR aracı başarıyla kiralandı")
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            // MovementActivity'e geçiş yap
                            Intent intent = new Intent(chrsatinalim.this, MovementActivity.class);
                            visibellel8 = true;
                            startActivity(intent);
                        }
                    });
