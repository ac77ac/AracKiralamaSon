...
public class mercedeseqesatinalim extends AppCompatActivity {
    public static boolean visibellel10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mercedeseqesatinalim);
    ...
    {
        Intent intent=new Intent(mercedeseqesatinalim.this,mercedeseqe.class);
    ...
    public void Onayla(View view) {
        ...
        if (selectedDate1.after(today) || selectedDate2.after(today)) {
            ...
            kiralamaBilgileri.put("Araç Model", "Mercedes EQE"); // Burada aracın kimliğini eklemelisiniz
            ...
            db.collection("Kullanıcılar.").document(uid).collection("Kiralananlar")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            Toast.makeText(mercedeseqesatinalim.this,"Kiralama bilgileri başarıyla eklendi:"+documentReference.getId(),Toast.LENGTH_SHORT).show();
                        }
                    });

            // AlertDialog oluştur
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("Mercedes EQE aracı başarıyla kiralandı")
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            // MovementActivity'e geçiş yap
                            Intent intent = new Intent(mercedeseqesatinalim.this, MovementActivity.class);
                            visibellel10=true;
                            startActivity(intent);
                        }
                    });
